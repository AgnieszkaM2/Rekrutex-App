...
if($pytaniedata!=null){
    ...
    $sql2 = "SELECT kategoria, tresc, login FROM pytania where (kategoria='$kategoria' and tresc ='$tresc')";
    $res = mysqli_query($con,$sql2);
    $row = mysqli_fetch_array($res);
    if(is_array($row)){
      http_response_code(400);
    }else{
      $sql = "INSERT INTO pytania(kategoria, tresc, odp1, odp2, odp3, odp4, poprawna, prawidlowa) VALUES('$kategoria', '$imie', '$odp1', '$odp2', '$odp3', '$odp4', '$poprawna', '$prawidlowa')";
